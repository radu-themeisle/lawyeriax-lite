...
function repeater_refresh_general_control_values(){
	jQuery(".repeater_general_control").each(function(){
		var values = [];
		var th = jQuery(this);
		th.find(".repeater_general_control_container").each(function(){
...
jQuery(document).ready(function(){
	...
	jQuery(".repeater_general_control_new_field").on("click",function(){
		...
		if(typeof th != 'undefined') {
            ...
            var field = th.find(".repeater_general_control_container:first").clone();
            if(typeof field != 'undefined'){
                ...
                th.find(".repeater_general_control_container:first").parent().append(field);
                repeater_refresh_general_control_values();
            }
