  ...
  <div class="news-title-wrap">
    ...
    <div class="news-post-title-wrap">
      <h4 class="news-post-title">
        <a href="<?php the_permalink() ?>" title="post title"><?php the_title(); ?></a>
      </h4>
    </div>
    <div class="news-posted-on">
      <a href="<?php the_author_link(); ?> " title="author name"><?php the_author(); ?> </a>
      <a href="<?php comments_link() ?>" title="comments number"><?php comments_number( 'no comments', '1 comment', '% comments' ); ?> </a>
    </div>
  </div>
  <?php if (has_post_thumbnail()) { ?>
  <div class="news-img-wrap">
    <a href="<?php the_permalink() ?>" title="post image">
